...
Script created by SQL Compare version 10.4.8 from Red Gate Software Ltd at 27/11/2014 12:36:47
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Dropping [dbo].[C_LADV_Personal_ResumenHorasPorMes]'
GO
DROP VIEW [dbo].[C_LADV_Personal_ResumenHorasPorMes]
GO
IF @@ERROR<>0 AND @@TRANCOUNT>0 ROLLBACK TRANSACTION
GO
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Dropping [dbo].[C_LADV_Personal_ResumenHorasPorMes_Aux]'
GO
DROP VIEW [dbo].[C_LADV_Personal_ResumenHorasPorMes_Aux]
GO
IF @@ERROR<>0 AND @@TRANCOUNT>0 ROLLBACK TRANSACTION
GO
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Dropping [dbo].[C_LADV_Personal_ResumenHorasPorMes_Aux2]'
GO
DROP VIEW [dbo].[C_LADV_Personal_ResumenHorasPorMes_Aux2]
GO
IF @@ERROR<>0 AND @@TRANCOUNT>0 ROLLBACK TRANSACTION
GO
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Dropping [dbo].[C_LADV_Stock_Almacenes]'
GO
DROP VIEW [dbo].[C_LADV_Stock_Almacenes]
GO
IF @@ERROR<>0 AND @@TRANCOUNT>0 ROLLBACK TRANSACTION
GO
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Dropping [dbo].[C_Almacen_ConStock]'
GO
DROP VIEW [dbo].[C_Almacen_ConStock]
GO
IF @@ERROR<>0 AND @@TRANCOUNT>0 ROLLBACK TRANSACTION
GO
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
...
(
[ID_Menus] [int] NOT NULL IDENTITY(1, 1),
...
(
[ID_Formulario_Usuario_Grupo] [int] NOT NULL IDENTITY(1, 1),
...
(
[ID_Informe_Plantilla] [int] NOT NULL IDENTITY(1, 1),
...
(
[ID_ListadoADV] [int] NOT NULL IDENTITY(1, 1),
...
(
[ID_Conexiones] [int] NOT NULL IDENTITY(1, 1),
[Codigo] [int] NOT NULL,
[Descripcion] [nvarchar] (100) COLLATE Modern_Spanish_CI_AS NOT NULL,
...
(
[ID_Gauge] [int] NOT NULL IDENTITY(1, 1),
[ID_ListadoADV] [int] NULL,
...
(
[ID_Informe_Apartado] [int] NOT NULL IDENTITY(1, 1),
[ID_Informe] [int] NOT NULL,
...
(
[ID_GaugeAgrupacion] [int] NOT NULL IDENTITY(1, 1),
[Codigo] [int] NOT NULL,
[Descripcion] [nvarchar] (100) COLLATE Modern_Spanish_CI_AS NOT NULL,
[FechaAlta] [smalldatetime] NOT NULL,
...
(
[ID_Form_Controls] [int] NOT NULL IDENTITY(1, 1),
...
(
[ID_BI] [int] NOT NULL IDENTITY(1, 1),
[Descripcion] [nvarchar] (200) COLLATE Modern_Spanish_CI_AS NOT NULL,
...
(
[ID_Informe_Apartado_Version] [int] NOT NULL IDENTITY(1, 1),
...
(
[ID_BI_Usuario] [int] NOT NULL IDENTITY(1, 1),
[ID_BI] [int] NOT NULL,
...
(
[ID_Informe_Plantilla_Apartado_Version] [int] NOT NULL IDENTITY(1, 1),
...
(
[ID_GaugeAgrupacion_Gauge] [int] NOT NULL IDENTITY(1, 1),
...
(
[ID_Listado_Entidad] [int] NOT NULL IDENTITY(1, 1),
[Descripcion] [nvarchar] (50) COLLATE Modern_Spanish_CI_AS NOT NULL,
...
(
[ID_ListadoADV_Agrupacion] [int] NOT NULL IDENTITY(1, 1),
[Codigo] [int] NOT NULL,
[Descripcion] [nvarchar] (100) COLLATE Modern_Spanish_CI_AS NOT NULL
)
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[prInicialitzarIdentitiesA5000]'
GO

CREATE PROCEDURE [prInicialitzarIdentitiesA5000]
AS
BEGIN
	...
	BEGIN      
	PRINT 'Reinicializando ' + @TableName
	if @TableName<>'Parte' and @TableName<>'Instalacion'
	begin
		DBCC CheckIdent (@TableName,RESEED, 50000)
	end
