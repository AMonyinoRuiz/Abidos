...
Run this script on:
        ...
        (local)\SQLEXPRESS.AbidosDomingo    -  This database will be modified
...
Script created by SQL Compare version 10.4.8 from Red Gate Software Ltd at 21/11/2014 10:56:57
...
[Firma] [nvarchar] (2000) COLLATE Modern_Spanish_CI_AS NULL
GO
...
Returns @Taula Table
(
ID_Producto int, ID_Almacen int, StockReal Decimal, StockTeorico decimal, ProductoCodigo  nvarchar(100), ProductoDescripcion nvarchar(250), AlmacenDescripcion nvarchar(250), ImporteStockReal Decimal (12,2), ImporteStockTeorico Decimal (12,2), ImportePVPStockReal Decimal (12,2)
)
as 
Begin
Insert into @Taula 
...
AS
SELECT        ID_Entrada, Codigo, [Descripción documento], FechaEntrada, ID_Entrada_Estado, Estado, ID_Entrada_Tipo, [Almacén de destino], ID_Almacen, 
                         [Tiop de documento], Almacén, [Código de Cliente], [Nombre del cliente], ID_Cliente, Télefono, [Povincia del cliente], [Persona de contacto], 
                         [Dirección del cliente], [Población del cliente], CASE ID_Entrada_Tipo WHEN 9 THEN Base WHEN 12 THEN Base * - 1 END AS Base, IVA, Descuento
FROM            dbo.C_Entrada
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Refreshing [dbo].[C_Instalacion_Contrato]'
GO
EXEC sp_refreshview N'[dbo].[C_Instalacion_Contrato]'
GO
IF @@ERROR<>0 AND @@TRANCOUNT>0 ROLLBACK TRANSACTION
GO
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      End
      Begin Tables = 
         Begin Table = "Instalacion_Contrato"
            Begin Extent = 
               Top = 6
               Left = 38
               Bottom = 302
            ...
            TopColumn = 0
         End
         Begin Table = "Instalacion_Contrato_TipoContrato"
            Begin Extent = 
               Top = 17
               Left = 565
               Bottom = 146
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         ...
         Output = 720
         Append = 1400
       ', 'SCHEMA', N'dbo', 'VIEW', N'C_Instalacion_Contrato', NULL, NULL
GO
IF @@ERROR<>0 AND @@TRANCOUNT>0 ROLLBACK TRANSACTION
GO
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
EXEC sp_updateextendedproperty N'MS_DiagramPane2', N'  NewValue = 1170
         SortType = 1350
         SortOrder = 1410
         GroupBy = 1350
         Filter = 1350
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[52] 4[3] 2[8] 3) )"
      End
      Begin PaneConfiguration = 1
         NumPanes = 3
         Configuration = "(H (1 [50] 4 [25] 3))"
