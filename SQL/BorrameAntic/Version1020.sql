...
Script created by SQL Compare version 10.4.8 from Red Gate Software Ltd at 21/11/2014 11:27:55
...
AS
SELECT        Codigo, [Descripción documento], FechaEntrada, Estado, [Nombre del cliente], Base, IVA, Descuento, Total, [Tiop de documento]
FROM            dbo.C_Entrada
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'C_LADV_Albaranes_de_Venta', NULL, NULL
GO
IF @@ERROR<>0 AND @@TRANCOUNT>0 ROLLBACK TRANSACTION
GO
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
